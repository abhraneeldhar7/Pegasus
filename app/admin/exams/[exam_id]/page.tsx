...
import { getExamWithQuestions } from "@/app/actions/examActions";
    ...
    return (<div className="min-h-[100vh] max-w-[800px] w-full mx-auto md:py-[40px] py-[55px] px-[15px]">
        ...
        <div className="mt-[40px] w-full">
            ...
            <div className="flex flex-col gap-[20px] mt-[10px]">
                ...
                {questions && questions.length == 0 && <div className="h-[200px] border bg-accent flex items-center justify-center w-full rounded-[15px] select-none cursor-pointer gap-[15px] font-[500] opacity-[0.7] shadow-md hover:scale-[0.95] transition-all duration-300" onClick={handleAddQuestion}>
